...
public class TaiKhoanBUS {
    ...
    public String deleteTaiKhoan(String username) {
        if (tkDAO.delete(username)) {
    ...
    public TaiKhoanDTO getByID(String username) {
        return tkDAO.getByID(username);
    }
}